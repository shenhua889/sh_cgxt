...
namespace sh_cgxt
{
    ...
    public sealed partial class MySqlHelper
    {
        ...
        public MySqlHelper()
        {
            ConnectionString = "Database='sh_cgxt';Data Source='127.0.0.1';User Id='root';Password='85459666'";
        }
        //}
        /// <summary>
        /// 数据库连接字符串
        ...
        /// <param name="commandText">SQL语句</param>
        /// <param name="parms">查询参数</param>
        /// <returns>返回最后添加的ID</returns>
        public long ExecuteLastID(string commandText, params MySqlParameter[] parms)
        {
            return ExecuteLastID(ConnectionString, CommandType.Text, commandText, parms);
        }
        ...
        /// <param name="parms">查询参数</param>
        /// <returns>返回最后添加的ID</returns>
        public static long ExecuteLastID(string connectionString, CommandType commandType, string commandText, params MySqlParameter[] parms)
        {
            using (MySqlConnection connection = new MySqlConnection(connectionString))
            {
                return ExecuteLastID(connection, commandType, commandText, parms);
            }
        }
        ...
        /// <param name="parms">查询参数</param>
        /// <returns>返回最后添加的ID</returns>
        public static long ExecuteLastID(MySqlConnection connection, CommandType commandType, string commandText, params MySqlParameter[] parms)
        {
            return ExecuteLastID(connection, null, commandType, commandText, parms);
        }
        ...
        /// <param name="parms">查询参数</param>
        /// <returns>返回最后添加的ID</returns>
        private static long ExecuteLastID(MySqlConnection connection, MySqlTransaction transaction, CommandType commandType, string commandText, params MySqlParameter[] parms)
        {
            MySqlCommand command = new MySqlCommand();
            PrepareCommand(command, connection, transaction, commandType, commandText, parms);
